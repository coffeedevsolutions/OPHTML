...
First stage of the [ps2ui toolchain](../../README.md): parses HTML and
...
other on every push. See [docs/format-ir.md](../../docs/format-ir.md)
for the IR and [docs/format-uib.md](../../docs/format-uib.md) for what
it becomes.
