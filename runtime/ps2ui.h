 ...
 * table is not 4-byte aligned, the tables do not fit in `size`, the
 * blob has no screens, or the arena would need more than `size_t`
 * holds. Each is also the answer for "do not bother calling load". */
