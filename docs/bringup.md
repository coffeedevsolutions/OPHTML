...
| SCPH-50000 | 6 testcard (run 190 build) | **PASS** — 4px and 2px rungs crisp against the flat references; 1px rung faint on the panel but proven live by the step 8 shimmer (a static grey is what a sampling mush looks like, and this was alternating). All four edge rules visible: primitives land exactly on the canvas edge, no half-pixel offset, no overscan loss |
