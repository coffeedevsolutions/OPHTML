...
| example  | G | C | textures | patch VRAM | total VRAM | |----------|---|---|----------|------------|------------| | opl-env  | 2 | 11| 11 -> 4  | 88 -> 32 KiB | 392 -> 336 KiB | | channel6 | 5 | 9 | 9 -> 11  | 72 -> 88 KiB | 280 -> 296 KiB |
channel6 draws five corner radii and paints each about twice, so it pays 16 KiB for the theming rather than being paid for it. The saving is a property of a STYLESHEET, not of the mechanism, and the mechanism's actual justification is that colour becomes reachable at all -- the VRAM went with it in one example and against it in the other.
