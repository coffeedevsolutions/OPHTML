...
| ci.permissions.allhosted | Every job across ci.yml, hw.yml and registry.yml runs on a GitHub-hosted runner (ubuntu-24.04, macos-14, or a matrix.os of those) and every workflow's permissions block is contents: read | .github/workflows/ci.yml:23,9-10; .github/workflows/hw.yml:31,51,188,742; .github/workflows/registry.yml:36,55,190 | grep runs-on and permissions across the three workflow files | verified |
