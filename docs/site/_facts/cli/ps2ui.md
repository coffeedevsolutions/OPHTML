...
|---|---|---|---|---|
| cli.ps2ui.version | `ps2ui --version` prints `ps2ui <ps2ui_bake.__version__>` on stdout and exits 0. The released version prints `ps2ui 0.8.0`; this tree prints `ps2ui 0.9.0.dev0`. | packages/baker/ps2ui_bake/ps2ui.py:486-487; packages/baker/ps2ui_bake/__init__.py:39 | `ps2ui --version` printed `ps2ui 0.9.0.dev0`, exit 0; `TestConsoleScriptVersions` in `packages/baker/tests/test_baker.py:3690` asserts the string against `__version__` | verified |
