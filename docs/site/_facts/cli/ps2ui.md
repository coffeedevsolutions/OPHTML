...
|---|---|---|---|---|
| cli.ps2ui.version | `ps2ui --version` prints `ps2ui <ps2ui_bake.__version__>` on stdout and exits 0. This tree is the 0.10.0 cut and prints `ps2ui 0.10.0`. | packages/baker/ps2ui_bake/ps2ui.py:519-520; packages/baker/ps2ui_bake/__init__.py:39 | `ps2ui --version` printed `ps2ui 0.10.0`, exit 0; `TestConsoleScriptVersions` in `packages/baker/tests/test_baker.py:3690` asserts the string against `__version__` | verified |
