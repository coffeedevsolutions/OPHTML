...
|---|---|---|---|---|
| slot.capacity.default | data-slot-capacity defaults to 63 | packages/layout/src/box.js:215 | compiled a slot with no capacity; ir.slots[0].capacity == 63 | verified |
