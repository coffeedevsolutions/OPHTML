...
Argument order does not matter. The bin applies `--mode` first and the two overrides afterwards, at [ps2ui-layout.js](repo:packages/layout/bin/ps2ui-layout.js#L89).
